# Tên file: GPU_MINER_LINUX.md
# Tính năng chi tiết: Hướng dẫn cài đặt driver, CUDA Toolkit và biên dịch GPU Miner trên hệ điều hành Linux (Ubuntu/Debian) để tham gia khai thác (mining).
